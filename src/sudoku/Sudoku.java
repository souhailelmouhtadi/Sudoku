...
public class Sudoku extends JFrame{
	...
	public void init(){
		...
		String[] algos = { "Backtracking", "ForwardChecking", "MinConflict" ,"MRV" , "AC3" };
...
//		g.drawRect(45,65, 320, 320); 
  ...
  //fonction qui compte les conflits de toutes les celulles
    ...
    public boolean isvalid(){
    	...
    	for (int i = 0; i < 9; i++) 
    		for (int j = 0; j < 9; j++)
    		{
    			...
    			//System.out.println(  i + " " + j + " " + valide[count]);    			
    			count++;
    ...
    public boolean ac3(int xi,int xj,int yi,int yj)
    { 
